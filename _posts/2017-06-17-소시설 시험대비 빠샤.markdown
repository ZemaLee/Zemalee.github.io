...
![Template Pattern](https://zemalee.github.io/images/Software_Engineering/07_Template_Method_Pattern.png)
...
/* 메인에서의 사용 */  
Product pc = ProductFactory.getProduct(
	new ComputerFactory(파라미터) );
```
